...
RSpec.describe PositionsController, type: :routing do
  describe "routing" do
    ...
    it "routes to #index" do
      expect(:get => "/positions").to_not route_to("positions#index")
    end
    ...
    it "routes to #create" do
      expect(:post => "/positions").to_not route_to("positions#create")
    end
    ...
    it "routes to #destroy" do
      expect(:delete => "/positions/1").to_not route_to("positions#destroy", :id => "1")
    end
  end
end
